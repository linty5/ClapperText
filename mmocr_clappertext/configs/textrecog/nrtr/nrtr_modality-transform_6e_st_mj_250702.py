"""ClapperText fine-tuning config for NRTR (Modality-Transform) (paper Tables 2 and 3)."""
...
_base_ = [
    ...
    "_base_nrtr_modality-transform_250702.py",
]

randomness = dict(seed=11)

load_from = "https://download.openmmlab.com/mmocr/textrecog/nrtr/nrtr_modality-transform_6e_st_mj/nrtr_modality-transform_6e_st_mj_20220916_103322-bd9425be.pth"

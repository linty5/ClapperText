"""Augmentation-ablation config for DBNet++ (ResNet-50) on ClapperText: all augmentations enabled (paper Sec. 4.3)."""
...
# learning policy
param_scheduler = [
    dict(type="LinearLR", end=20, start_factor=0.001),
    dict(type="PolyLR", power=0.9, eta_min=1e-7, begin=20, end=120),
]

"""Augmentation-ablation config for NRTR-R31 (1/16) on ClapperText: all augmentation modules disabled, 100-epoch schedule (duplicate of the non-suffixed variant) (paper Table 4)."""
...
# optimizer
optim_wrapper = dict(type="OptimWrapper", optimizer=dict(type="Adam", lr=1e-5))  # 3e-4
train_cfg = dict(type="EpochBasedTrainLoop", max_epochs=36, val_interval=1)
val_cfg = dict(type="ValLoop")
test_cfg = dict(type="TestLoop")
# learning policy
param_scheduler = [
    dict(type="MultiStepLR", milestones=[18, 24], end=36),
]

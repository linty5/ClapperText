"""Augmentation-ablation config for NRTR-R31 (1/16) on ClapperText: all augmentation modules enabled, 100-epoch schedule (duplicate of the non-suffixed variant) (paper Table 4)."""
...
# learning policy
param_scheduler = [
    dict(type="MultiStepLR", milestones=[50, 75], end=100),
]
